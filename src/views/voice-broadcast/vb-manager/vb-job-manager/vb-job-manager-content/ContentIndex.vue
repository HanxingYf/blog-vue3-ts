...
import ContentNormal from './content/ContentNormal.vue'
import CodeDiffNormal from './codediff/CodeDiffNormal.vue'
import queryString from 'query-string'

@Component({ components: { ContentNormal, CodeDiffNormal } })
