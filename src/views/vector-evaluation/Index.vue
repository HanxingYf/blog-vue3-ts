    ...
    return [
      {
        ...
        subMenuItems: [
          {
            name: 'vector-create-task',
            to: '/vector-evaluation/create-task',
            title: '创建任务'
          },
          {
            name: 'vector-completed-tasks',
      ...
      },
      {
        ...
        subMenuItems: [
          {
            name: 'vector-task-manager',
            to: '/vector-evaluation/task-manager',
            title: '评测管理'
          },
          {
            name: 'vector-task-evaluation',
            to: '/vector-evaluation/task-evaluation',
            title: '评测标注'
          }
        ]
      }
