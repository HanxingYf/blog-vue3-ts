...
export default class BaseMapEvaluation extends Vue {
  get menus(): SubMenuI[] {
    return [
      {
        name: 'machine',
        ...
        subMenuItems: [
          {
            name: 'basemap-create-task',
            to: '/basemap-evaluation/create-task',
            title: '创建任务'
          },
          {
            name: 'basemap-completed-tasks',
            to: '/basemap-evaluation/completed-tasks',
            title: '已完成任务'
          }
        ]
      },
      {
        ...
        subMenuItems: [
          {
            name: 'basemap-task-manager',
            to: '/basemap-evaluation/task-manager',
            title: '评测管理'
          },
          {
            name: 'basemap-task-evaluation',
            to: '/basemap-evaluation/task-evaluation',
            title: '评测标注'
          }
        ]
      }
